...
![Terminal.app](https://raw.github.com/alexfilatov/dotfiles/master/iterm/nick-terminal.png)
...
```sh
$ git clone https://github.com/alexfilatov/dotfiles.git ~/.dotfiles
$ cd ~/.dotfiles
$ chmod +x setup.sh
$ ./setup.sh
```
...
```sh
sh -c "`curl -fsSL https://raw.github.com/alexfilatov/dotfiles/master/remote-setup.sh`"
```

Or, using wget:

```sh
sh -c "`wget -O - --no-check-certificate https://raw.githubusercontent.com/alexfilatov/dotfiles/master/remote-setup.sh`"
```
